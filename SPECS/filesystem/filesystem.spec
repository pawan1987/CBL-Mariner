...
# Hack to work around toolkit limitations
if [[ -e /usr/share/xml/iso-codes/iso_639.xml && -e /usr/share/xml/iso-codes/iso_3166.xml ]]; then
...
%changelog
* Tue Dec 12 12:08:24 EST 2023 Dan Streetman <ddstreet@ieee.org> - 3.18-7
- Initial import to Azure Linux
- Fix some invalid dates in imported changelog
- Remove some dirs: afs, games, X11
