...
Provides:       zstd-libs = %{version}-%{release}
Obsoletes:      zstd-libs <= 1.5.5-2
...
%changelog
* Wed Jan 31 14:14:49 EST 2024 Dan Streetman <ddstreet@ieee.org> - 1.5.5-5
